...
//    char data[256];
    ...
    while(
        fabs(calc_theta - (angle[0]*0.17578125)) > 0.4 ||
        fabs(calc_theta - (angle[1]*0.17578125)) > 0.4 ||
        fabs(calc_theta - (angle[2]*0.17578125)) > 0.4 ||
        fabs(calc_theta - (angle[3]*0.17578125)) > 0.4
        ){

        if(fabs(calc_theta - (angle[0]*0.17578125)) > 0.4){
            OC1R = (calc_theta > angle[0]*0.17578125) ? Duty_Calculation(50) : 0;
            OC5R = (calc_theta < angle[0]*0.17578125) ? (Duty_Calculation(50)) : 0;
        }
        if(fabs(calc_theta - (angle[1]*0.17578125)) > 0.4){
            OC2R = (calc_theta > angle[1]*0.17578125) ? Duty_Calculation(50) : 0;
            OC6R = (calc_theta < angle[1]*0.17578125) ? (Duty_Calculation(50)) : 0;
        }
        if(fabs(calc_theta - (angle[2]*0.17578125)) > 0.4){
            OC3R = (calc_theta > angle[2]*0.17578125) ? Duty_Calculation(50) : 0;
            OC7R = (calc_theta < angle[2]*0.17578125) ? (Duty_Calculation(50)) : 0;
        }
        if(fabs(calc_theta - (angle[3]*0.17578125)) > 0.4){
            OC4R = (calc_theta > angle[3]*0.17578125) ? Duty_Calculation(50) : 0;
            OC8R = (calc_theta < angle[3]*0.17578125) ? (Duty_Calculation(50)) : 0;
        }
    }
