...
#pragma config PLLDIV = DIV2             // PLL Input Prescaler Select bits (PLL is disabled)
...
// CONFIG2
#pragma config POSCMD = NONE            // Primary Oscillator Select (Primary Oscillator Disabled) 外部オシレータ設定
...
#pragma config FNOSC = FRCPLL           // Initial Oscillator Select (Fast RC Oscillator with Postscaler (FRCDIV))　オシレータ（システムクロック）設定　PLL未使用・FRCDIV / PLL使用・FRCPLL
